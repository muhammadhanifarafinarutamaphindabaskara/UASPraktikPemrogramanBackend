				...
				<li class="span4">
				  ...
				  <p style="min-height:160px">
					...
					<div class="caption">
					  ...
					  <h4 style="text-align:center"><a class="btn" href="<?php echo site_url('produk/detailproduk/'.$produk->id);?>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="<?php echo site_url('Produk/add_to_cart/'.$produk->id);?>">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp. <?php echo number_format($produk->harga,0,',','.');?></a></h4>
					</div>
				  </div>
				</li>
				<?php endforeach;?>
